...
import mock
from makostats.fbScrapeStats import get_html_for_team, _get_team_name, _get_all_html
from makostats.fbConsts import TEAMS, URL_LIST


class FbScrapeStatsTests(TestCase):

    @mock.patch("makostats.fbScrapeStats.requests.get")
    ...
    @mock.patch("makostats.fbScrapeStats.time.sleep")
    @mock.patch("makostats.fbScrapeStats.BeautifulSoup")
    @mock.patch("makostats.fbScrapeStats.requests.get")
